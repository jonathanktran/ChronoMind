...
def run_homescreen():
    ...
    buttons = [
        Button((DISPLAY_WIDTH / 2, DISPLAY_HEIGHT/3), (DISPLAY_WIDTH / 8, DISPLAY_HEIGHT / 8), color.WHITE,
               fonts.HUD.render('Play', False, color.BLACK)),

        Button((DISPLAY_WIDTH / 2, DISPLAY_HEIGHT /2), (DISPLAY_WIDTH / 8, DISPLAY_HEIGHT / 8), color.WHITE,
               fonts.HOME.render('Credits', False, color.BLACK)),

        Button((DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 1.5), (DISPLAY_WIDTH / 8, DISPLAY_HEIGHT / 8), color.WHITE,
               fonts.QUIT.render('Quit', False, color.BLACK))
    ]
