...
add(8000, rounds.Sprinkler(enemies.Bullet, MIDDLE_LEFT, DISPLAY_WIDTH, DIR_RIGHT, -45, 45, 90, BLUE, 8, 2000/8))
add(10000, rounds.Sprinkler(enemies.Bullet, MIDDLE_RIGHT, DISPLAY_WIDTH, DIR_LEFT, DIR_BOTTOM_LEFT, DIR_TOP_LEFT, 90, BLUE, 8, 2000/8))
add(12000, rounds.Sprinkler(enemies.Bullet, MIDDLE_TOP, DISPLAY_HEIGHT, DIR_DOWN, DIR_BOTTOM_RIGHT, DIR_BOTTOM_LEFT, 90, BLUE, 8, 2000/8))
add(14000, rounds.Sprinkler(enemies.Bullet, MIDDLE_BOTTOM, DISPLAY_HEIGHT, DIR_UP, DIR_TOP_LEFT, DIR_TOP_RIGHT, 90, BLUE, 8, 2000/8))
